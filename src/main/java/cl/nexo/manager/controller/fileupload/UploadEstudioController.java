...
public class UploadEstudioController {
    ...
    public @ResponseBody Map list(MultipartHttpServletRequest request, 
	    ...
	    AccessLeerCargaSam leer = (AccessLeerCargaSam) context.getBean("AccessLeerCargaSam");
            ...
            File newFile = new File(storageDirectory  + newFilename);
            	...
            	try {
	            	...
	            	*/
	            	...
	            	leer.leerArchivoRespuestas(urlBaseFisica+"cargasSAM/"+fechaNow1+"/"+fil.getNewFilename());

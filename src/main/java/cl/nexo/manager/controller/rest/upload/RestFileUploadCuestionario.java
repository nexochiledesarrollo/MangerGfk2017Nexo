...
@RestController
@RequestMapping("/RestFileUploadCuestionario")
public class RestFileUploadCuestionario {
	 /***************************************************
	...
	private static final Logger logger = Logger.getLogger(RestFileUploadCuestionario.class);

...
public class Workflow15 implements AccessWorkflow15 {
	...
	@Override
	public ArrayList<ObjEstudio> getListEstudioByUserActivacion(int id, String lang){
		ArrayList<ObjEstudio> result = new ArrayList<ObjEstudio>();
		
		ArrayList<ObjEstudio> result1 = this.getListEstudioByUserResActivacion(1,id,lang);
		ArrayList<ObjEstudio> result2 = this.getListEstudioByUserResActivacion(2,id,lang);
		ArrayList<ObjEstudio> result3 = this.getListEstudioByUserResActivacion(3,id,lang);
	...
	public ArrayList<ObjEstudio> getListEstudioByUserResActivacion(int idUser, int User, String lang){
		...
		String query="SELECT "
				  ...
				  query = query + " AND o.cola_operacion =  " + Constantes.Cola_Pdte_activacion;
				  query = query + " ORDER BY o.id_operacion DESC ";
		try {
			  conn = dataSource.getConnection();
			  PreparedStatement ps = conn.prepareStatement(query);

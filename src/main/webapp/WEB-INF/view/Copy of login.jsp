	...
	<div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand">
                    <span class="logo"></span> <strong> <span style="color: #eb6d16;">GfK</span></strong>-Adimark
            ...
            <div class="login-content">
                ...
                <form name="loginForm"  action="<c:url value='/j_spring_security_check' />" method="POST" class="margin-bottom-0">
                    ...
                    <div class="login-buttons">
                        <button type="submit" class="btn btn-warning btn-block btn-lg" id="btn_submit" >Ingresar</button>

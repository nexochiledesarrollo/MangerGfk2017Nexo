...
<%
 ObjLoginUser user = (ObjLoginUser) request.getAttribute("user");
...
<body class="pace-top" onload="document.loginForm.username.focus();">
	...
	<div class="login-cover">
	    <div class="login-cover-image"><img src="<c:url value="/resources/manager/img/login-bg/bg-6.jpg" />" data-id="login-cover-image" alt=""></div>
	...
	<div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand">
                    <span class="logo"></span> GFK-Adimark
                    <small>Plataforma de Gesti&oacute;n de Proyecto</small>
                </div>
                <div class="icon">
            ...
            <div class="login-content">
                ...
                <form name="loginForm"  class="margin-bottom-0">
                    <div class="form-group m-b-20">
                        <input type="text"  class="form-control input-lg" value="<%= user.getNombre_user() %> <%= user.getApp_user() %>" readonly="readonly">
                        <input type="hidden" name="text_00" id="text_00" class="form-control input-lg" value="<%= user.getId_user() %>" >
                    </div>
                    
                    <div class="form-group m-b-20">
                        <input type="password" name="text_01" id="text_01" class="form-control input-lg" placeholder="Ingresa Nuevo Password">
                    </div>
                    <div class="form-group m-b-20">
                        <input type="password" name="text_02" id="text_02" class="form-control input-lg" placeholder="Re-ingresa Nuevo Password">
                    </div>
                    <div class="login-buttons">
                        <button type="button" class="btn btn-success btn-block btn-lg" onclick="JavaScript: activarCuenta();">Activar</button>
                    </div>
                    <div class="m-t-20">
       ...
       <%@ include file="general-modal.jsp" %>
        <ul class="login-bg-list">
            <li class="active"><a href="#" data-click="change-bg"><img src="<c:url value="/resources/manager/img/login-bg/bg-6.jpg" />" alt=""></a></li>
            <li><a href="#" data-click="change-bg"><img src="<c:url value="/resources/manager/img/login-bg/bg-2.jpg" />" alt=""></a></li>

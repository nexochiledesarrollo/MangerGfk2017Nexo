...
<body>
	...
	<!-- begin #page-container -->
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;" class="active">Mantenedor de Usuario</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Mantenedor de Usuario <small>Gesti&oacute;n de Usuarios</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Detalle Usuarios</h4>
                        </div>
                        <%if(permiso_access == 1 || permiso_access == 2){ %>
                        	<button type="button" class="btn btn-success" onclick="JavaScript: showModalCreateUser();"><i class="fa fa-edit"></i> Crear Usuario</button>
                        	<button type="button" class="btn btn-warning" onclick="JavaScript: showModalUploadUser();"><i class="fa fa-cloud-upload"></i> Importar Usuarios</button>
                        <%} %>
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Detalle Perfil Usuarios</h4>
                         </div>   
                         <%if(permiso_access == 1 || permiso_access == 2){ %>
	                       	<button type="button" class="btn btn-success" onclick="JavaScript: showModalCreatePerfil();"><i class="fa fa-edit"></i> Crear Perfil</button>
	                     <%} %>
	                     <!-- Begin Panel Body -->
                         <div class="panel-body">
				...
				<div class="modal-content">
					...
					<div class="alert alert-danger fade in m-b-15" id="error-newlogin">
						...
						<div class="row">
						    ...
						    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">RUN <span style="color: red;">(*)</span></label>
		                            <input type="text" class="form-control" placeholder="Ingrese RUN" name="txt_01" id="txt_01" onBlur="JavaScript: parseRut($('#txt_01').val(),'txt_01')">
		                        </div>
		                    </div>
		                    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">Nombre de Usuario <span style="color: red;">(*)</span></label>
		                            <input type="text" class="form-control" placeholder="Ingrese Nombre de Usuario" name="txt_02" id="txt_02" >
		                        </div>
		                    </div>
		                </div>
		                <p></p>
		                ...
		                <div class="row">
		                    ...
		                    <div class="col-md-6">
								<div class="form-group">
		                            ...
		                            <input type="text" class="form-control clsDatePicker" placeholder="Ingrese Fecha de Nacimiento" name="txt_06" id="txt_06">
		                ...
		                <div class="row">
						    ...
						    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">Divisi&oacute;n <span style="color: red;">(*)</span></label>
		                    ...
		                    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">Sub-Divisi&oacute;n <span style="color: red;">(*)</span></label>
		                            <select class="form-control" name="txt_088" id="txt_088" onchange="JavaScript: chargePerfilCombo(1,'txt_07','txt_088'); chargeCargoCombo('txt_10','txt_088');">
		                            	<option value="0">Seleccione</option>
		                            </select>
		                        </div>
		                    </div>
		                ...
		                <div class="row">
						    ...
						    <div class="col-md-6">
								<div class="form-group">
		                            ...
		                            <select class="form-control" name="txt_10" id="txt_10">
		                            	<option value="0">Seleccione</option>
		                            </select>
		                        </div>
		                    </div>
		                    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">Perfil <span style="color: red;">(*)</span></label>
		                            <select class="form-control" name="txt_07" id="txt_07">
		                            	<option value="0">Seleccione</option>
		                            </select>
		                        </div>
		                    </div>
		                ...
		                <div class="row">
						    ...
						    <div class="col-md-6">
								...
								<div class="input-group">
		                            ...
		                            <select class="form-control" name="txt_09" id="txt_09"></select>
		                        </div>
		                         -->
		                         <div class="form-group">
		                            <label class="">Estado <span style="color: red;">(*)</span></label>
		                            <select class="form-control" name="txt_11" id="txt_11">
		                    ...
		                    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">Es Usuario Manager <span style="color: red;">(*)</span></label>
		                            <select class="form-control" name="txt_111" id="txt_111">
		                ...
		                <div class="row">
		                    ...
		                    <div class="col-md-6">
								...
								<div class="input-group">
		                            ...
		                            <select class="form-control" name="txt_12" id="txt_12"></select>
		                        </div>
		                         -->
		                    </div>
		                </div>
		                <br/>
		                <legend class="pull-left width-full">Tipo de Trabajador</legend>
		                <p></p>
		                <div class="row">
						    <!-- begin col-12 -->
						    <div class="col-md-6">
								<div class="form-group">
		                            ...
		                            <select class="form-control" name="txt_13" id="txt_13"></select>
		                        </div>
		                    </div>
		                    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">Tipo de Pago</label>
		                            <select class="form-control" name="txt_14" id="txt_14"></select>
		                        </div>
		                    </div>
		                </div>
		                <p></p>
		                <div class="row">
						    ...
						    <div class="col-md-6">
								<!-- 
								<div class="input-group">
		                            <span class="input-group-addon">Tipo de Jornada</span>
		                            <select class="form-control" name="txt_15" id="txt_15"></select>
		                        </div>
		                         -->
		                    </div>
		                    <div class="col-md-6">
								...
								<div class="input-group">
		                            ...
		                            <select class="form-control" name="txt_16" id="txt_16"></select>
		                        </div>
		                         -->
		                ...
		                <br/>
		                <legend class="pull-left width-full">Ubicaci&oacute;n</legend>
		                <div class="row">
						    <!-- begin col-12 -->
						    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">Lenguaje Plataforma</label>
		                            <select class="form-control" name="txt_198" id="txt_198" style="width: 100%">     	
		                          	</select>
		                        </div>
		                    </div>
		                    <div class="col-md-6">
		                ...
		                <div class="row">
						    ...
						    <div class="col-md-6">
								<div class="form-group">
		                            ...
		                            <select class="form-control" name="txt_17" id="txt_17" onchange="JavaScript: chargeComboRegion('txt_18',$('#txt_17').val(),0,0);">     	
		                          	</select>
		                        </div>
		                    </div>
		                    <div class="col-md-6">
								...
								<div class="form-group">
		                            ...
		                            <select class="form-control" name="txt_18" id="txt_18" onchange="JavaScript: chargeComboCiudad('txt_19',$('#txt_18').val(),0,0);">
		                            </select>
		                        </div>
		                ...
		                <div class="row">
						    ...
						    <div class="col-md-6">
								<div class="form-group">
		                            ...
		                            <select class="form-control" name="txt_19" id="txt_19" onchange="JavaScript: chargeComboComuna('txt_199',$('#txt_19').val(),0,0);">
		                            </select>
		                        </div>
		                    </div>
		                    <div class="col-md-6">
								 <div class="form-group">
									 ...
									 <select class="form-control" name="txt_199" id="txt_199">
			                          </select>
			                      </div>
							</div>
		                </div>
		                ...
		                <div class="row">
						    ...
						    <div class="col-md-6">
								<div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="Ingresa Direcci&oacute;n" name="txt_21" id="txt_21">
		                        </div>
		                    </div>
		                    <div class="col-md-6">
		                         ...
		                         <div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="Ingresa N&uacute;mero" name="txt_25" id="txt_25">
		                        </div>
		                ...
		                <div class="row">
						    ...
						    <div class="col-md-6">
								<div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="Ingresa Departamento (Opcional)" name="txt_26" id="txt_26">
		                        </div>
		                    </div>
		                    <div class="col-md-6">
		                         ...
		                         <div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="Ingresa Anexo" name="txt_20" id="txt_20">
		                        </div>
		                ...
		                <div class="row">
						    ...
						    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">C&oacute;digo Postal</label>
		                            <input type="text" class="form-control" placeholder="Ingresa C&oacute;digo Postal (Opcional)" name="txt_27" id="txt_27">
		                        </div>
		                    </div>
		                    <div class="col-md-6">
		                ...
		                <br/>
		                <legend class="pull-left width-full">Herramientas Externas</legend>
		                <p></p>
		                <div class="row">
						    <!-- begin col-12 -->
						    <div class="col-md-6">
								<div class="form-group">
		                            <label class="">Id SAM</label>
		                            <input type="text" class="form-control" placeholder="Ingresa Id SAM" name="txt_23" id="txt_23">
		                        </div>
		                    </div>
		                    <div class="col-md-6">
								...
								<div class="form-group">
		                            ...
		                            <select class="form-control" name="txt_24" id="txt_24">
					...
					<div class="modal-footer">
						...
						<a href="JavaScript: createLoginUser();" class="btn btn-lg btn-success" id="button-createuser">Crear Usuario</a>
						<a href="JavaScript: updateLoginUser();" class="btn btn-lg btn-warning" id="button-updateuser">Actualizar Usuario</a>
						<a href="JavaScript: showModalDeleteUser();" class="btn btn-lg btn-danger" id="button-deleteuser">Eliminar Usuario</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="<c:url value="/resources/app/usuario/modulo.js" />"></script>

...
<head>
	<meta charset="utf-8">
	<title><%= lang1.getProperty("title3") %></title>
...
<body>
	...
	<!-- begin #header -->
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Mantenedor de Estudio</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Mantenedor de Estudio <small>Gestión de Estudios...</small></h1>
			<!-- end page-header -->
	...
	<script src="<c:url value="/resources/app/proyecto/modulo.js" />"></script>

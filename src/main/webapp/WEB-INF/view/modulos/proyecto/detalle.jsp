	...
	<!-- begin #page-container -->
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active" id="li_estudio">Detalle de Estudio</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
...
<!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->												
                           ...
                           <div class="row">
                           	    ...
                           	    <div class="form-group col-md-6">
		                            ...
		                            <p class="text-right m-b-0" style="margin-right: 20px;">
	                           	  		...
	                           	  		<a href="javascript:;" class="btn btn-success" id="btn_mod_cal_02"><i class="fa fa-calendar"></i> Actualiza Fecha</a>
	                           	  	</p>
                           ...
                           <div class="col-md-12">
	                        	<div class="panel-body panel-form" style="margin-top: 10px;">
		                           ...
		                           <ul class="nav nav-tabs">
										...
										<li class=""><a href="#work-etapa-2" data-toggle="tab" aria-expanded="false">Implementacion</a></li>
										<li class=""><a href="#work-etapa-3" data-toggle="tab" aria-expanded="false">Recoleccion</a></li>
										<li class=""><a href="#work-etapa-4" data-toggle="tab" aria-expanded="false">Codificacion</a></li>
										<li class=""><a href="#work-etapa-5" data-toggle="tab" aria-expanded="false">Digitacion</a></li>
										<li class=""><a href="#work-etapa-6" data-toggle="tab" aria-expanded="false">Depuracion</a></li>
										<li class=""><a href="#work-etapa-7" data-toggle="tab" aria-expanded="false">Tabulacion</a></li>
										<li class=""><a href="#work-etapa-8" data-toggle="tab" aria-expanded="false">Entrega</a></li>
									</ul>
										<div class="tab-content">
												...
												<div class="row">
					                           	  	<div class="form-group col-md-6">
							                                ...
							                                <tbody>
							                                    <tr>
							                                        ...
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_01" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
							                                    ...
							                                    <tr>
							                                        ...
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_02" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
													...
													<div class="row">
						                           	  	<div class="form-group col-md-12">
						                           	  		...
						                           	  		<table class="table table-bordered" id="workt_id1">
								                                <thead>
								                                    <tr>
								                                        <th>Detalle</th>
								                                        <th>Estado</th>
											...
											<div class="tab-pane fade" id="work-etapa-2">
												<h3 class="m-t-10" style="color: #f59c1a;"><i class="fa fa-cog"></i> Fechas de Ejecución Etapa</h3>
												<div class="row">
					                           	  	<div class="form-group col-md-6">
							                                ...
							                                <tbody>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Inicio Implementación </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_03" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
							                                        
							                                        </td>
							                                    </tr>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Fin Implementación </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_04" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
													...
													<div class="row">
						                           	  	<div class="form-group col-md-12">
						                           	  		...
						                           	  		<table class="table table-bordered" id="workt_id2">
								                                <thead>
								                                    <tr>
								                                        <th>Detalle</th>
								                                        <th>Estado</th>
											...
											<div class="tab-pane fade" id="work-etapa-3">
												<h3 class="m-t-10" style="color: #f59c1a;"><i class="fa fa-cog"></i> Fechas de Ejecución Etapa</h3>
												<div class="row">
					                           	  	<div class="form-group col-md-6">
							                                ...
							                                <tbody>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Inicio Recolección </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_05" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
							                                        
							                                        </td>
							                                    </tr>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Fin Recolección </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_06" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
											...
											<div class="tab-pane fade" id="work-etapa-4">
												<h3 class="m-t-10" style="color: #f59c1a;"><i class="fa fa-cog"></i> Fechas de Ejecución Etapa</h3>
												<div class="row">
					                           	  	<div class="form-group col-md-6">
							                                ...
							                                <tbody>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Inicio Codificación </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_07" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
							                                        
							                                        </td>
							                                    </tr>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Fin Codificación </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_08" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
											...
											<div class="tab-pane fade" id="work-etapa-5">
												<h3 class="m-t-10" style="color: #f59c1a;"><i class="fa fa-cog"></i> Fechas de Ejecución Etapa</h3>
												<div class="row">
					                           	  	<div class="form-group col-md-6">
							                                ...
							                                <tbody>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Inicio Digitación </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_09" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
							                                        
							                                        </td>
							                                    </tr>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Fin Digitación </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_10" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
											...
											<div class="tab-pane fade" id="work-etapa-6">
												<h3 class="m-t-10" style="color: #f59c1a;"><i class="fa fa-cog"></i> Fechas de Ejecución Etapa</h3>
												<div class="row">
					                           	  	<div class="form-group col-md-6">
							                                ...
							                                <tbody>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Inicio Depuración </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_11" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
							                                        
							                                        </td>
							                                    </tr>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Fin Depuración </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_12" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
											...
											<div class="tab-pane fade" id="work-etapa-7">
												<h3 class="m-t-10" style="color: #f59c1a;"><i class="fa fa-cog"></i> Fechas de Ejecución Etapa</h3>
												<div class="row">
					                           	  	<div class="form-group col-md-6">
							                                ...
							                                <tbody>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Inicio Tabulación </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_13" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
							                                        
							                                        </td>
							                                    </tr>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Fin Tabulación </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_14" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
											...
											<div class="tab-pane fade" id="work-etapa-8">
												<h3 class="m-t-10" style="color: #f59c1a;"><i class="fa fa-cog"></i> Fechas de Ejecución Etapa</h3>
												<div class="row">
					                           	  	<div class="form-group col-md-6">
							                                ...
							                                <tbody>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Inicio Entrega </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_15" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
							                                        
							                                        </td>
							                                    </tr>
							                                    <tr>
							                                        <td><label class="control-label col-lg-12" style="font-weight: bold;">Fecha Fin Entrega </label></td>
							                                        <td>
							                                        	<div class="col-md-12">
									                                       <input type="text" id="work_fechas_16" style="font-size: 20px; color: blue; " class="form-control"  value="" readonly="readonly" />
																		</div>
            ...
            <!-- end row -->
            <!-- Begin row -->
            <div class="row" id="row_encuestas">
			    <!-- begin col-12 -->
			    <div class="col-md-12">
			        <!-- begin panel -->
                    <div class="panel panel-inverse">
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                         ...
                         <a href="JavaScript: getListTrazaByIdOp();"  class="btn btn-primary m-r-5" style="margin-top: 5px; margin-left:10px; text-align: center;" >
                         	  	<i class="fa fa-search fa-2x pull-left"></i>

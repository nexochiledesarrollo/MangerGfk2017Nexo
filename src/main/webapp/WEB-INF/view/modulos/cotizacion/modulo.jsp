...
<%
 ...
 URL url = application.getResource("/WEB-INF/lang/"+tol.getLang()+"/estudio.properties");
...
<head>
	<meta charset="utf-8">
	<title><%= lang1.getProperty("title2") %></title>
...
<body>
	...
	<!-- begin #page-container 
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active"><%= lang1.getProperty("navEstudio2") %></li>
				
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Mantenedor de Cotizaciones <small>Gestión de Cotizaciones...</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <%if(permiso_access == 1 || permiso_access == 2){ %>
	                       	<a href="/Manager/cotizacionService/New" class="btn btn-success"><i class="fa fa-edit"></i> Crear Nueva Cotización</a>
	                     <%} %>
	                     <input type="hidden" id="aux_01" name="aux_01" value="<%= tol.getLang() %>" />
	...
	<script src="<c:url value="/resources/app/cotizacion/modulo.js" />"></script>

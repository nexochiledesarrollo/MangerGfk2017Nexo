...
<!-- END Config General -->
    ...
    <input type="hidden" class="form-control" id="aux_02" value="<%= legal_entity %>" />
    <input type="hidden" class="form-control" id="aux_03" value="9" />
    <input type="hidden" class="form-control" id="aux_04" value="" />
    <input type="hidden" class="form-control" id="aux_05" value="<%= moneda %>" />
    <input type="hidden" class="form-control" id="aux_06" value="<%= geografia %>" />
    <input type="hidden" class="form-control" id="aux_07" value="<%= sector %>" />
    <input type="hidden" class="form-control" id="aux_08" value="1" /><!-- val new cotizacion -->
    <input type="hidden" class="form-control" id="aux_09" value="24" /><!-- id operacion -->
    <input type="hidden" class="form-control" id="aux_10" value="1" /><!-- Estado SET UP 2 -- 1 insert 2 UPDATE -->
    <input type="hidden" class="form-control" id="aux_11" value="1" /><!-- BUSSNESS CASE -- 1 insert 2 UPDATE -->
<!-- Notify -->
	<input type="hidden" class="form-control" id="not_01" value="<%= lang1.getProperty("notifyInsertTittle") %>" />
	<input type="hidden" class="form-control" id="not_02" value="<%= lang1.getProperty("notifyInsertText") %>" />
	<input type="hidden" class="form-control" id="not_03" value="<%= lang1.getProperty("notifyUpdateTittle") %>" />
	<input type="hidden" class="form-control" id="not_04" value="<%= lang1.getProperty("notifyUpdateText") %>" />
	<input type="hidden" class="form-control" id="not_05" value="<%= lang1.getProperty("notifyErrorTittle") %>" />
	<input type="hidden" class="form-control" id="not_06" value="<%= lang1.getProperty("notifyErrorText") %>" />
<!-- End Notify -->    
...
<!-- Error value page 2 -->
	 <input type="hidden" class="form-control" id="errorv_44" value="<%= lang1.getProperty("errorv_44") %>" />
	 <input type="hidden" class="form-control" id="errorv_45" value="<%= lang1.getProperty("errorv_45") %>" />
	 <input type="hidden" class="form-control" id="errorv_57" value="<%= lang1.getProperty("errorv_57") %>" />
	 <input type="hidden" class="form-control" id="errorv_58" value="<%= lang1.getProperty("errorv_58") %>" />
	 <input type="hidden" class="form-control" id="errorv_59" value="<%= lang1.getProperty("errorv_59") %>" />
<!-- End Error value page 1 -->
<!-- Error value page 3 -->
	 <input type="hidden" class="form-control" id="errorv_114" value="<%= lang1.getProperty("errorv_114") %>" />
	 <input type="hidden" class="form-control" id="errorv_115" value="<%= lang1.getProperty("errorv_115") %>" />
	 <input type="hidden" class="form-control" id="errorv_entre1" value="<%= lang1.getProperty("errorv_entre1") %>" />
<!-- End Error value page 3 -->
<!-- Error value page 4 -->
	 <input type="hidden" class="form-control" id="errorv_169" value="<%= lang1.getProperty("errorv_169") %>" />
	 <input type="hidden" class="form-control" id="errorv_170" value="<%= lang1.getProperty("errorv_170") %>" />
	 <input type="hidden" class="form-control" id="errorv_171" value="<%= lang1.getProperty("errorv_171") %>" />
	 <input type="hidden" class="form-control" id="errorv_172" value="<%= lang1.getProperty("errorv_172") %>" />
	 <input type="hidden" class="form-control" id="errorv_173" value="<%= lang1.getProperty("errorv_173") %>" />
	 <input type="hidden" class="form-control" id="errorv_174" value="<%= lang1.getProperty("errorv_174") %>" />
	 <input type="hidden" class="form-control" id="errorv_175" value="<%= lang1.getProperty("errorv_175") %>" />
	 <input type="hidden" class="form-control" id="errorv_176" value="<%= lang1.getProperty("errorv_176") %>" />
	 <input type="hidden" class="form-control" id="errorv_177" value="<%= lang1.getProperty("errorv_177") %>" />
	 <input type="hidden" class="form-control" id="errorv_178" value="<%= lang1.getProperty("errorv_178") %>" />
	 <input type="hidden" class="form-control" id="errorv_179" value="<%= lang1.getProperty("errorv_179") %>" />
	 <input type="hidden" class="form-control" id="errorv_180" value="<%= lang1.getProperty("errorv_180") %>" />
	 <input type="hidden" class="form-control" id="errorv_181" value="<%= lang1.getProperty("errorv_181") %>" />
	 <input type="hidden" class="form-control" id="errorv_182" value="<%= lang1.getProperty("errorv_182") %>" />
	 <input type="hidden" class="form-control" id="errorv_183" value="<%= lang1.getProperty("errorv_183") %>" />
	 <input type="hidden" class="form-control" id="errorv_184" value="<%= lang1.getProperty("errorv_184") %>" />
	 <input type="hidden" class="form-control" id="errorv_185" value="<%= lang1.getProperty("errorv_185") %>" />
	 <input type="hidden" class="form-control" id="errorv_186" value="<%= lang1.getProperty("errorv_186") %>" />
	 <input type="hidden" class="form-control" id="errorv_187" value="<%= lang1.getProperty("errorv_187") %>" />
	 <input type="hidden" class="form-control" id="errorv_188" value="<%= lang1.getProperty("errorv_188") %>" />
	 <input type="hidden" class="form-control" id="errorv_189" value="<%= lang1.getProperty("errorv_189") %>" />
<!-- End Error value page 4 -->
...
<%
 ...
 URL url = application.getResource("/WEB-INF/lang/"+langOption+"/activity.properties");
...
<body>
			...
			<div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
	                    ...
	                    <input type="hidden" id="aux_02" name="aux_01" value="<%= aux_refresco %>" />
	...
	<script src="<c:url value="/resources/app/cuestionario/modulo.js" />"></script>

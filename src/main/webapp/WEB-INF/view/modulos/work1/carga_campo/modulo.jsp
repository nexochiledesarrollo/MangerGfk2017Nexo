...
<body>
	...
	<!-- begin #header -->
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Carga Datos de Campo<small><%= lang1.getProperty("nuevoSmallHeader") %></small></h1>
			<!-- end page-header -->
                            ...
                            <table id="data-table1" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
								        ...
								        <th width="100">Cod Tipo de entrevistas</th>
	...
	<script src="<c:url value="/resources/app/carga_campo/modulo.js" />"></script>

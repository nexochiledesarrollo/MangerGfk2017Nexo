...
var handleDataTableProyecto = function() {
	...
	var table = $("#data-table1").DataTable({
        ...
        "scrollX": true,
        ajax: {
            url: "/Manager/RestWorkflow5/getListWorkflowUpload?id=0&lang="+$('#aux_01').val(),
...
//	         }
	...
	table.on('dblclick', 'tr', function () {
        ...
        window.open("/Manager/workflowEtapa1/detalleUploadCuestionario?id="+data["id_operacion"]+"&nombre="+nombre, "_self");

...
var handleDataTableProyecto = function() {
	...
	var table = $("#data-table1").DataTable({
        ...
        "scrollX": true,
        ajax: {
            url: "/Manager/RestWorkflow15/getListWorkflowRevDispositivo?id=0&lang="+$('#aux_01').val(),
...
//	         }
	...
	table.on('dblclick', 'tr', function () {
        ...
        var nombre = encodeURIComponent(data["nombre_operacion"]);
         ...
         window.open("/Manager/workflowEtapa1/DetalleRevisionFondos?id="+data["id_operacion"]+"&nombre="+nombre+"&tipo=2&valor=4", "_self");

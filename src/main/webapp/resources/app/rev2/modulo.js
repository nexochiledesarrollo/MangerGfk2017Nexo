...
var handleDataTableProyecto = function() {
	...
	var table = $("#data-table1").DataTable({
        ...
        "scrollX": true,
        ajax: {
            url: "/Manager/RestWorkflow15/getListWorkflowRevProducto?id=0&lang="+$('#aux_01').val(),
...
//	         }
	...
	table.on('dblclick', 'tr', function () {
        ...
        window.open("/Manager/workflowEtapa1/DetalleRevisionFondos?id="+data["id_operacion"]+"&nombre="+nombre+"&tipo=2&valor=2", "_self");
